...
import com.mariotti.developer.futureclock.functions.AlarmFunctionsKt;
import com.mariotti.developer.futureclock.models.Alarm;

import java.util.UUID;

public class AlarmDeleteFragment extends DialogFragment {
	public static final String EXTRA_DELETE_CONFIRM =
					"com.mariotti.developer.futureclock.controller.confirm";
	...
	public static AlarmDeleteFragment newInstance(Alarm alarm) {
		...
		args.putString(ARG_TIME, AlarmFunctionsKt.getHourAndMinuteAsString(alarm.getHour(), alarm.getMinute()));
		args.putString(ARG_DAYS, AlarmFunctionsKt.getShortDaysString(alarm));
